...
void GameStateManager::hatPressed(int k)
{
	gameStates[currentState]->hatPressed(k);
}
void GameStateManager::hatReleased(int k)
{
	gameStates[currentState]->hatReleased(k);
}
